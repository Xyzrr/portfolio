...
<ButtonGroup>
  <Button icon="sports_esports" href="https://johnqian.com/tetris">
    Play
  </Button>
  <Button icon="code" href="https://github.com/Xyzrr/xyzrr.github.io">
    Code
  </Button>
</ButtonGroup>
