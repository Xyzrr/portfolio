...
Next we tackled a more fundamental problem.

Initially, a report was essentially a collection of panels. More precisely, a report was a collection of sections, and a section was a collection of panels along with a dataset to hydrate the panels. A panel could contain either a chart, a table, or text.
